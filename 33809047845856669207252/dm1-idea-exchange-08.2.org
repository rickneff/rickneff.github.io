...
* TODO Read and Write About Creativity --- The Vary Idea!
  Steve Olson has a lot more to say about the uses of combinatorics, as you will
  see. [[https://firstthreeodds.org/17657741833134731255/creativity.html][This excerpt]] from the same book that the above quote came from has some
  bearing on your *Idea Exchange* of last week. Ponder what the connection is,
  and discuss what you think it is.

  In addition, read [[http://www.cs.princeton.edu/courses/archive/spr05/cos126/lectures//22.pdf][Princeton COS126 Lecture 22 slides about cryptology]] (at that
